...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/mtake/webpro/boshop/public/storage' => 'string',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/mtake/webpro/boshop/public/storage','fortify.guard',
...
'session.secure','session.http_only','session.same_site','session.partitioned','typescript-transformer.auto_discover_types',
...
'typescript-transformer.transform_to_native_enums','typescript-transformer.transform_null_to_optional','boost.enabled','boost.browser_logs_watcher','structure-discoverer.ignored_files',
...
'boost.browser-logs','login','login.store','logout','password.confirm',
...
'app','laradumps::output','laradumps::summary','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state',
